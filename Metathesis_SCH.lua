...
function init_gear_sets()
	...
	sets.midcast.Kaustra = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Dosis Tathlum",
		...
		back="Bookworm's Cape",waist="Fucho-no-Obi",legs="Hagondes Pants +1",feet="Gendewitha Galoshes +1"}
	...
	sets.midcast.Impact = {main="Atinian Staff",sub="Mephitis Grip",ammo="Dosis Tathlum",
		...
		back="Bookworm's Cape",waist=gear.ElementalObi,legs="Hagondes Pants",feet="Bokwus Boots"}
...
---ALT + F12 is REMOVE PDT OR MDT SETS 
	...
	sets.idle.Field.PDT = {main="Bolelabunga",sub="Genbu's Shield",ammo="Brigantia Pebble",
