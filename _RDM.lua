...
function init_gear_sets()
	...
	sets.midcast.FastRecast = {main="Lehbrailg +2",sub="Arbuda Grip",ammo="Incantor Stone",
		head="Nahtirah Hat",ear2="Loquacious Earring",
		body="Hedera Cotehardie",hands="Gendewitha Gages +1",ring1="Prolix Ring",
back="Estoqueur's Cape",waist="Witful Belt",legs="",feet="Gendewitha Galoshes +1"}

	sets.midcast['Haste II'] = {main="Lehbrailg +2",sub="Arbuda Grip",ammo="Incantor Stone",
		head="Nahtirah Hat",ear2="Loquacious Earring",
		body="Hedera Cotehardie",hands="Gendewitha Gages +1",ring1="Prolix Ring",
back="Estoqueur's Cape",waist="Witful Belt",legs="",feet="Gendewitha Galoshes +1"}
	...
	sets.midcast['Enhancing Magic'] = {ammo="Savant's Treatise",main="Chatoyant Staff",sub="Fulcio Grip",
		head="Savant's Bonnet +2",neck="Enhancing Torque",back="Estoqueur's Cape",
		body="Anhur Robe",hands="Ayao's Gages",feet="Rubeus Boots",
		waist="Olympus Sash",legs="Warlock's Tights"}
	...
	sets.midcast['Enfeebling Magic'] = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Kalboron Stone",
		...
		body="Estoqueur's Sayon +2",hands="Lurid Mitts",ring1="Sangoma Ring",ring2="Strendu Ring",
		back="Ogapepo Cape",waist="Sekhmet Corset",legs="Hagondes Pants +1",feet="Umbani Boots"}
	...
	sets.midcast['Elemental Magic'].Resistant = {main="Lehbrailg +2",sub="Mephitis Grip",ammo="Dosis Tathlum",
		...
		back="Toro Cape",waist="Olympus Sash",legs="Hagondes Pants +1",feet="Umbani Boots"}
...
---ALT + F12 is REMOVE PDT OR MDT SETS 
	...
	sets.idle.Field = {main="Bolelabunga",sub="Genbu's Shield",ammo="Incantor Stone",
		head="Duelist's Chapeau +2",neck="Twilight Torque",ear1="Gifted Earring",ear2="Loquacious Earring",
		body="Hagondes Coat +1",hands="Serpentes Cuffs",ring2="Dark Ring",ring1="Defending Ring",
		back="Umbra Cape",waist="Fucho-No-Obi",legs="Nares Trews",feet="Serpentes Sabots"}
	...
	sets.idle.Field.PDT = {main="Terra's Staff",sub="Arbuda Grip",ammo="Incantor Stone",
		...
		back="Shadow Mantle",waist="Flume Belt",legs="Hagondes Pants +1",feet="Gendewitha Galoshes +1"}
	...
	sets.defense.PDT = {main="Terra's Staff",sub="Arbuda Grip",ammo="Brigantia Pebble",
		...
		body="Hagondes Coat +1",hands="Gendewitha Gages +1",ring2="Dark Ring",ring1="Defending Ring",
		back="Umbra Cape",waist="Flume Belt",legs="Hagondes Pants +1",feet="Umbani Boots"}
...
---ALT + F12 is REMOVE PDT OR MDT SETS 
	...
	sets.buff['Saboteur'] = {head="Estoqueur's Gantherot's +1"}
